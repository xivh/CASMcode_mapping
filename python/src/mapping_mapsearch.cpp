...
PYBIND11_MODULE(mapsearch, m) {
  ...
  py::class_<PrimSearchData, std::shared_ptr<PrimSearchData>>(
      ...
      .def(py::init<std::shared_ptr<xtal::BasicStructure const>,
          ...
          prim : casm.xtal.Prim
              ...
              may be mapped to
          override_prim_factor_group : Optional[List[casm.xtal.SymOp]]
  ...
  m.def(
      ...
      R"pbdoc(
        ...
        Parameters
        ----------
        prim_structure_data : casm.mapping.mapsearch.StructureSearchData
        ...
        Returns
        -------
        superstructure_data : casm.mapping.mapsearch.StructureSearchData
  ...
  py::class_<MappingSearch>(m, "MappingSearch", R"pbdoc(
      ...
      - The method :func:`~casm.mapping.mapsearch.MappingSearch.results` returns the current mapping results (including approximate ties with the current k_best result).
      ...
      .def(py::init<double, double, int, AtomCostFunction, TotalCostFunction,
          ...
          atom_cost_f : function, default=`~casm.mapping.mapsearch.SymmetryBreakingAtomCost()`
      ...
      .def("results", &combined_results,
          ...
          Returns
          -------
          structure_mappings : List[Tuple[casm.mapping.info.StructureMappingCost, casm.mapping.info.StructureMapping]]
              A list of tuple of :class:`~casm.mapping.info.StructureMappingCost`
              and `casm.mapping.info.StructureMapping`, giving possible structure
  ...
  py::class_<QueueConstraints>(m, "QueueConstraints", R"pbdoc(
      ...
      a :class:`~casm.mapping.mapsearch.MappingSearch` and
